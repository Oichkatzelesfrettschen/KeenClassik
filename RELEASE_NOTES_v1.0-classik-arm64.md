...
- **Four difficulty levels**: Easy, Normal, Hard, and Extreme
...
- Legacy puzzle presets and tuning for Classik (Modern/Legacy profiles)
- UI polish for large screens and accessibility
- Advanced modes live in the separate KeenKenning repo, if applicable

---

**Questions or Issues?** Visit your GitHub repository or open an issue.
