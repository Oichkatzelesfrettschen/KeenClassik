...
gh release edit v1.0-classik-arm64-release \
    --repo <your-org>/KeenClassik \
    --notes-file RELEASE_NOTES_v1.0-classik-arm64.md
```

### Option 3: Via GitHub Web Interface

1. Go to your KeenClassik release page for tag `v1.0-classik-arm64-release`
...
- Mentions what's coming next (Kenning variant in a separate repo, if applicable)
